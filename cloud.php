...
<body>
<nav class="navbar sticky-top navbar-expand-lg mt-5" id="navbar">
    <div class="container">
        <button class="navbar-toggler bg-white" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav nav-pills navbar-nav w-100 d-flex justify-content-between mb-2 " id="pills-tab" role="tablist">
                <li  class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-cloud-tab" data-bs-toggle="pill" data-bs-target="#pills-cloud" type="button" role="tab" aria-controls="pills-cloud" aria-selected="true"  style="color:white" >IFS Cloud</button>
                </li>
                <li  class="nav-item" role="presentation">
                <button class="nav-link" id="pills-ERP-tab" data-bs-toggle="pill" data-bs-target="#pills-ERP" type="button" role="tab" aria-controls="pills-ERP" aria-selected="false" style="color:white">IFS ERP</button>
                </li>
                <li  class="nav-item" role="presentation">
                <button class="nav-link" id="pills-EAM-tab" data-bs-toggle="pill" data-bs-target="#pills-EAM" type="button" role="tab" aria-controls="pills-EAM" aria-selected="false" style="color:white">IFS Enterprise Asset Management</button>
                </li>
                <li  class="nav-item" role="presentation">
                <button class="nav-link" id="pills-FSM-tab" data-bs-toggle="pill" data-bs-target="#pills-FSM" type="button" role="tab" aria-controls="pills-FSM" aria-selected="false" style="color:white">IFS Field Service Management</button>
                </li>
            </ul>
        </div>
    </div>
...
<div class="tab-pane fade show active" id="pills-cloud" role="tabpanel" aria-labelledby="pills-home-tab">
            ...
            <div class="row align-items-stretch">
                <div class="col-lg-8 mt-md-2  d-flex" style=" background: linear-gradient(143.1deg, #42348B 24.41%, #A677C5 132.12%);padding:20px;border-radius:20px;color:white;  line-height: 1.2; ">
                    <div class="container">
                        ...
                        <p class="text">It found that the major areas in savings came from:</p>
                        <ul class="text">
                            <li>Labor Efficiencies Reallocated To <br>Growth Activities</li>
                            <li>Capital Cost.</li>
                            <li>Reporting And Uptime.</li>
                            <li>Savings From Decommissioning <br>Legacy On-Prem Environment.</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 mt-md-2 mt-2 d-flex">
                    <div class="rlt_card  text-center w-100 d-flex flex-column justify-content-center"style=" background-image: linear-gradient(to bottom right, #42348B, #A677C5);padding:20px;border-radius:20px;color:white;">
                        <h5 class="text fs-4">Access the full report below for more information:</h5>
                        <a href="#" target="_blank" class="text-decoration-none">
                            <div style="background-color: #EDDFFB;" class="rounded-pill px-3 py-2 d-inline-flex align-items-center justify-content-around">
                                <h6 style="color: #845EC2;" class="mb-0">Download PDF</h6>
                                <img src="assets/download.png" width="25" alt="phone_img" class="img-fluid ms-3">
                            </div>
                        </a>
                    </div>
                </div>
    ...
    <div class="row my-2 align-items-stretch d-flex ">
            ...
            <div class="card rounded-4" style="background: #F6F0FF;border:none;">
                <div class="card-body">
                    ...
                    <div style="background-color:#845EC2;" class="rounded-pill px-3 py-1 d-inline-flex align-items-center justify-content-around">
                                ...
                                <img src="assets/white-download.png" width="25" alt="phone_img" class="img-fluid ms-3">
                            </div>
                    </a>
                </div>
            </div>
        ...
        <div class="col-lg-6 mt-md-2 mt-2">
...
<!-- ERP section -->
<div class="tab-pane fade" id="pills-ERP" role="tabpanel" aria-labelledby="pills-profile-tab">
 <div class="container mt-4">
    ...
    <div class="row align-items-stretch ">
        <div class="col-lg-4 d-flex flex-column mt-2 ">
            <div class="card IFS " style="color:#03143D">Manufacturing</div>
            <div class="card IFS" style="color:#03143D">CRM</div>
            <div class="card IFS" style="color:#03143D">Procurement</div>
            <div class="card IFS" style="color:#03143D">Human Capital Management</div>
            <div class="card IFS" style="color:#03143D">Projects</div>
            <div class="card IFS" style="color:#03143D">Finance</div>
            <div class="card IFS" style="color:#03143D">Supply Chain Management</div>
            <div class="card IFS" style="color:#03143D">E-Commerce</div>
        </div>
        <div class="col-lg-8 d-flex" >
            <div class="row align-items-stretch">
            ...
            <div class="card rounded-4" style="background: #F6F0FF;border:none;  box-shadow: 1px 4px 4px rgba(0, 0, 0, 0.2);">
                <div class="card-body">
                    ...
                    <div style="background-color:#845EC2;" class="rounded-pill px-2 py-1 d-inline-flex align-items-center justify-content-around">
                                <h6 style="color:white;font-size:14px" class="mb-0">Download PDF</h6>
                                <img src="assets/white-download.png" width="20" alt="phone_img" class="img-fluid ms-3">
                            </div>
                    </a>
                </div>
            </div>
        ...
        <div class="col-lg-6 mt-md-2 mt-2">
            <div class="card rounded-4" style="background-color:#F2F6FF;border:none;  box-shadow: 1px 4px 4px rgba(0, 0, 0, 0.2);">
                <div class="card-body">
                    ...
                    <div style="background-color:#845EC2;" class="rounded-pill px-2 py-1 d-inline-flex align-items-center justify-content-around">
                                <h6 style="color:white;font-size:14px" class="mb-0">Download PDF</h6>
                                <img src="assets/white-download.png" width="20" alt="phone_img" class="img-fluid ms-1">
                            </div>
                    </a>
                </div>
            </div>
...
<!-- EAM -->
<div class="tab-pane fade" id="pills-EAM" role="tabpanel" aria-labelledby="pills-profile-tab">
<div class="container mt-4 mb-5">
          ...
          <div class="col-xl-4 d-flex flex-column mt-2 ">
              ...
              <div class="d-flex flex-column ">
                <h2 class="text ms-2" style="font-weight:bold;font-size:30px"><span style="color:#350064;">IFS</span> Cloud</h2>
                  ...
                  <div class="card IFS"style="color:#03143D">Asset and fleet management</div>
                  <div class="card IFS"style="color:#03143D">Maintenance, Repair and Overhaul</div>
              </div>
              <h2 class="text ms-2" style="font-weight:bold;font-size:30px"><span style="color:#350064;">IFS</span> Ultimo</h2>
              <div class="d-flex flex-column ">
  ...
  <!-- FSM -->
  <div class="tab-pane fade" id="pills-FSM" role="tabpanel" aria-labelledby="pills-FSM-tab">
  <div class="container mt-4 mb-5">
...
<div class="row align-items-stretch ifs_fsm">
    <div class="col-lg-4 d-flex flex-column mt-2 " >
        ...
        <div class="card IFS "style="color:#03143D">Mobile Workforce Management</div>
        <div class="card IFS "style="color:#03143D">Contracts and Warranties</div>
        <div class="card IFS "style="color:#03143D">Remote Assistance</div>
        <div class="card IFS "style="color:#03143D">Workforce scheduling &amp;planning</div>
        ...
        <div class="row my-2 ">
            ...
            <div class="card rounded-4" style="background: #F2F6FF;border:none;  box-shadow: 1px 4px 4px rgba(0, 0, 0, 0.2);">
                    <div class="card-body">
                        ...
                        <div style="background-color:#845EC2;" class="rounded-pill px-3 py-1 d-inline-flex align-items-center justify-content-around">
                                    <h6 style="color:white;font-size:14px" class="mb-0">Download PDF</h6>
                                    <img src="assets/white-download.png" width="25" alt="phone_img" class="img-fluid ms-1">
                                </div>
                        </a>
                    </div>
                </div>
